...
export class PathUtils {
     ...
     * 获取规范的路径。
     */
    public static getRegularPath(path: string): string {
        if (path == null) {
            return null;
        }
        return path.replace('\\', '/');
     ...
     * 获取连接后的路径。
     */
    public static getCombinePath(...path: string[]): string {
     ...
     */
    public static getRemotePath(...path: string[]): string {
     ...
     * 根据文件路径获取文件的完整名称
     */
    public static getFileNameInPath(path: string): string {
     ...
     * 根据文件路径获取文件的后缀名
     */
    public static getExtensionByFilePath(filePath: string): string {
     ...
     * 通过路径获得最后一个文件夹的父路径
     */
    public static getParentPathOfLastFoulder(path: string): string {
