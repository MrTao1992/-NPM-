declare module 'zm_core/src/zm-app' {
...
declare module 'zm_core/src/interfaces' {
	 global {
	    namespace egf {
	        interface IModule {
	            /**模块名 */
...
declare module 'zm_core' {
	export * from 'zm_core/src/zm-app';
	export * from 'zm_core/src/interfaces';
